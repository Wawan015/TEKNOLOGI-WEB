                    ...
                    <div class="form">
                        <div class="a">
                            <div class="col-sm-12 text-center" style="margin-bottom:20px">
                                <div class="row ">
                                    <div class="colom"><a href="#"><img src="media/house.png" height="80px"><span style="font-size:20px; "> Profile Wawan Ponsel</span></a></div>
                        ...
                        <div class="b">
                            <div class="col-sm-12 text-center" style="margin-bottom:20px">
                                <div class="row ">
                                    <div class="colom"><a href="#"><img src="media/support.png" height="80px"><span style="font-size:20px; "> Pelayanan Pelanggan </span></a></div>
                                </div>
                            </div>
                        </div>
                        <div class="c">
                            <div class="col-sm-12 text-center" style="margin-bottom:20px">
                                <div class="row ">
                                    <div class="colom"><a href="#"><img src="media/hammer.png" height="80px"><span style="font-size:20px;"> Cek Status pengerjaan</span></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
